...
internal class PriceDTOTest {
    ...
    fun testEquals() {
        ...
        val priceDTO1 = PriceDTO(1L, idProduct100, priceTypeDTO, BigDecimal.valueOf(10.00))
        val priceDTO2 = PriceDTO(1L, idProduct100, priceTypeDTO, BigDecimal.valueOf(10.00))
